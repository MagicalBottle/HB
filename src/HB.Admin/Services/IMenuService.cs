...
namespace HB.Admin.Services
{
    ...
    public interface IMenuService:IBaseService<SysMenu>
    {
        ...
        /// <returns></returns>
        List<SysMenu> GetMenus(int pageNumber = 1, int pageSize = 10, string menuName = null, string menuSystermName = null, string sortName = "Id", string sortOrder = "ASC");
        ...
        /// <param name="excludeId">排查某个菜单，id</param>
        /// <returns></returns>
        bool ExistMenuByMenuSystermName(string menuSystermName, int excludeId = 0);
        ...
        /// <returns></returns>
        List<SysMenu> GetMenusByAdminId(int adminId);
